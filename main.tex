...
\begin{itemize}[leftmargin=*, topsep=0pt, label={}]
	...
	\item{\textbf{AI:} Machine Learning, Deep Learning (CNN, GAN, LSTM), Computer Vision, Object (detection, segmentation, and pose estimation)}%deep predictive learning
...
\begin{itemize}[leftmargin=*, topsep=0pt, label={}]
	...
	\item{\textbf{Robots:} Fetch, UR5, HRP2, Puli Rover, Seekur Jr.}%fetch
	\item{\textbf{Languages:} Python, C/C++, MATLAB, HTML, CSS}
	\item{\textbf{AI Tools:} TensorFlow, PyTorch, Scikit-learn, OpenCV} %ONNX
