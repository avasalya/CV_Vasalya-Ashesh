...
\geometry{
	hmargin=1.cm, % Horizontal margin
	vmargin=1.35cm, % Vertical margin
...
% \definecolor{headings}{HTML}{0000A0} % Dark red colour for headings
% \definecolor{shade}{HTML}{ADD8E6} % Peach colour for the contact information box
% \definecolor{linkcolor}{HTML}{A40000} % 25% desaturated headings colour for links

\definecolor{headings}{HTML}{701112} % Dark red colour for headings
\definecolor{shade}{HTML}{DCDCDC} % Peach colour for the contact information box
\definecolor{linkcolor}{HTML}{0000EE} % 25% desaturated headings colour for links
...
\newcommand{\workposition}[3]{
	\expandafter\ifstrequal\expandafter{#1}{}{}{{\raggedright\large #1}\\} % job title
	\expandafter\ifstrequal\expandafter{#2}{}{}{{\raggedright\large #2}\\[4pt]} % description
	\expandafter\ifstrequal\expandafter{#3}{}{}{#3\\} % Description
}


\newcommand{\workpositionmulti}[5]{
	\expandafter\ifstrequal\expandafter{#1}{}{}{{\raggedright\large #1}\\} % company name
	\expandafter\ifstrequal\expandafter{#2}{}{}{{\raggedright\large #2}\\[4pt]} % title year
	\expandafter\ifstrequal\expandafter{#3}{}{}{#3\\{\\}} % Description
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\large #4}\\[4pt]} % title year
